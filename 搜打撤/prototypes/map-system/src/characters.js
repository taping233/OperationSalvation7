...
const CHARACTERS = Object.freeze([
  { id: 'shuangling', name: '霜翎', rulesetId: '侠客', visualId: 'shuangling', color: '#ed9b53', tag: '穿越风雪的刀锋', bg: '白发高马尾的远征队尖兵。她习惯在风雪里先走一步，把危险留在自己的刀锋前。', task: '沿废城的旧通信线路寻找失联队员，带着所有人的讯息返回营地。', role: '突进 · 斩击', skin: '#edc3ac', hair: '#e7edf0', outfit: '#26333d', scale: 1 },
  { id: 'baiqi', name: '白契', rulesetId: '降临者', visualId: 'baiqi', color: '#ad9ddd', tag: '未署名的契约', bg: '总是穿着整洁白西装的眼镜男子。他知道隔离区封锁前的秘密，却只愿以契约交换答案。', task: '回收中央遗迹的封存档案，查明自己签署过的最后一份契约。', role: '契印 · 异变', skin: '#dec0af', hair: '#29313d', outfit: '#e8e5dc', scale: 1.12 },
