...
const CHARACTERS = Object.freeze([
  ...
  { id: 'xuanli', name: '玄砾', rulesetId: '战士', color: '#d0805a', skin: '#69463d', hair: '#ecedf0', outfit: '#303b42', scale: 1.25 },
  { id: 'dengkui', name: '灯葵', rulesetId: '牧师', color: '#81bcb0', skin: '#dcb397', hair: '#285a59', outfit: '#dedbd0', scale: 1 },
].map(Object.freeze));
