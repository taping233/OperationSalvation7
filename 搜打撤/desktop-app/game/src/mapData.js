...
SDT.MAP = {
  ...
  boardId: 'B1',
  boardName: '废校操场 · 三环棋盘',
  // 12×12 仅作为世界坐标基准（576px 世界）；轨道拓扑仍由 makeRing 的 8×8 抽象环生成，
  ...
  nodeLayout: {
    radii: [240, 168, 100],  // 三环基础半径（外 / 中 / 内）
    radiusJitter: 24,        // 半径抖动幅度（± 一半）
    angleJitter: 0.38,       // 角度抖动（占相邻角距的比例上限）
    bossRadius: 46,          // BOSS 结点环绕祭坛的半径
    minGap: 46,              // 同环相邻结点的最小间距（含结点半径余量）
  },
